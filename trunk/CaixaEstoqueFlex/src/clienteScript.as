 ...
 */ 
private var fields:Object = { 'codigo':Number, 'nome':String, 'tipoPessoa':Number, 'sexo':Number, 'dataNascimento':Date, 'endereco':String, 'bairro':String, 'cidade':String, 'UF':String, 'cep':String, 'cpf_cnpj':String, 'insc_estadual':String, 'fone':String, 'contato':String, 'email':String, 'url':String, 'obs':String};
...
private function editCellEnd(e:DataGridEvent):void
{
    ...
    var parameters:* =
    {
        "codigo": vo.codigoCol,        "nome": vo.nomeCol,        "tipoPessoa": vo.tipoPessoaCol,        "sexo": vo.sexoCol,        "dataNascimento": vo.dataNascimentoCol,        "endereco": vo.enderecoCol,        "bairro": vo.bairroCol,        "cidade": vo.cidadeCol,        "UF": vo.UFCol,        "cep": vo.cepCol,        "cpf_cnpj": vo.cpf_cnpjCol,        "insc_estadual": vo.insc_estadualCol,        "fone": vo.foneCol,        "contato": vo.contatoCol,        "email": vo.emailCol,        "url": vo.urlCol,        "obs": vo.obsCol    }
...
private function insertItem():void {
    var parameters:* =
    {
        "method": "Insert",		"nome": nomeCol.text,		"tipoPessoa": tipoPessoaCol.text,		"sexo": sexoCol.text,		"dataNascimento": dataNascimentoCol.text,		"endereco": enderecoCol.text,		"bairro": bairroCol.text,		"cidade": cidadeCol.text,		"UF": UFCol.text,		"cep": cepCol.text,		"cpf_cnpj": cpf_cnpjCol.text,		"insc_estadual": insc_estadualCol.text,		"fone": foneCol.text,		"contato": contatoCol.text,		"email": emailCol.text,		"url": urlCol.text,		"obs": obsCol.text    };
...
public function deleteHandler(e:*):void
{
    ...
    {
        var codigo:Number = parseInt(e.data.toString(), 10);
        for (var index:Number = 0; index < dataArr.length; index++)
        {
            if (dataArr[index].codigoCol == codigo)
            {
