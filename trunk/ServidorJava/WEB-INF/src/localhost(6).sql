...
--
-- Servidor: localhost
-- Tempo de Geração: Set 16, 2010 as 10:37 
...
--
CREATE DATABASE `caixaeestoque` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `caixaeestoque`;
...
(2, 'HITALO', 0, 0, '2010-09-13 00:00:00', '', '', '', 'PE', '', '', '', '123456467', '', 'ANDERSON.XRILO@GMAIL.COM', '', '1.00', '', '2010-09-13 00:00:00');
...
INSERT INTO `compra` (`codigo`, `NF`, `codUsuario`, `codFornecedor`, `dataCompra`) VALUES
(1, 'sdfsdf', 0, 3, '2010-09-15 12:52:49');
...
INSERT INTO `itenscompra` (`codigo`, `codCompra`, `codProduto`, `quantidade`, `valorCompra`) VALUES
(1, 1, 1, 1, 0);
...
(10, 0, '2010-09-15 00:02:21', 2, 'null', '0.00');
...
(1, '', 2, 'PREGO GRANDE', '', 2, 4, 0, '85.00', 3, '1.00', '1.00', '');
...
--
-- Restrições para a tabela `itenscompra`
--
ALTER TABLE `itenscompra`
  ADD CONSTRAINT `fk_compra` FOREIGN KEY (`codCompra`) REFERENCES `compra` (`codigo`),
  ADD CONSTRAINT `fk_produto` FOREIGN KEY (`codProduto`) REFERENCES `produto` (`codigo`);
